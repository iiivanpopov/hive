    ...
    <div className="flex justify-between">
      ...
      >
        <DropdownMenuTrigger className={cn(
          'flex gap-1 cursor-pointer hover:bg-zinc-200 transition-colors px-2 ml-2 py-1 rounded-sm items-center max-w-34 w-full justify-between',
          !isOwner && 'max-w-44',
        )}
        >
          <div className="w-full flex gap-1.5 items-center truncate">
            <GlobeIcon
              size={20}
              className="shrink-0"
            />
